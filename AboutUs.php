...
<body>
    ...
    <div class="heading">
        ...
        <p>
            ...
            designs that redefine performance and fashion. Rolex: Fueling your journey to greatness, one step at a time.
        </p>
    </div>
    <div class="container">
        <section class="about">
            <div class="about-img">
                <img src="rolex.jpg" alt="NIKE">
            </div>
            <div class="about-content">
                <h2>Step into greatness with Us</h2>
                <p>
                    Embark on a journey of excellence with us, a brand synonymous with the pinnacle of innovation and
                    unmatched
                    style. From the courts to the streets, Rolex's commitment to pushing boundaries shines through in
                    every
                    ...
                    or a
                    trendsetter making a statement, Watches is your partner in unlocking your full potential.
                    At Us, we are more than a brand; we are a movement fueled by innovation and inspiration. Our
                    mission is
                ...
                <a href="https://www.rolex.com/en-us/" target="_blank" class="read-more">Read More</a>
            </div>
        </section>
    </div>
